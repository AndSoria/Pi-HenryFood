...
const Detail = ()=>{
    ...
    const recipe= useSelector(state=>state.recipeId) //toma el array que esta en la propiedad recipes del estado global
    ...
    useEffect(()=>{
        ...
        dispatch(recipeById(id))
            ...
            // const recipe=arrayPruebaApi.find(recipe=>recipe.id===Number(id))
