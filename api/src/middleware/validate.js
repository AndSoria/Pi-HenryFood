const validate=(req, res, next)=>{
    ...
    const validImage = /^(image\/(png|jpg|jpeg|gif|bmp))$/; //validation for image file
    ...
    if(healthScore<1 || healthScore>100) return res.status(400).json({error:'The score must be between 1 and 100 '})
